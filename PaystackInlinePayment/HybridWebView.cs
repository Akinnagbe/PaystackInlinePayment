...
namespace Plugin.PaystackInlinePayment
{
    public class HybridWebView : View
    {
        ...
        Action closeAction;
        public static readonly BindableProperty UriProperty = BindableProperty.Create(nameof(Uri), typeof(string), typeof(HybridWebView), defaultValue: string.Empty, defaultBindingMode: BindingMode.TwoWay);
        /// <summary>
